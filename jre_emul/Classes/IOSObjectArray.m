...
+ (instancetype)arrayWithLength:(NSUInteger)length type:(IOSClass *)type {
  return [IOSObjectArray_CreateArray((jint)length, type) autorelease];
}
...
+ (instancetype)arrayWithObjects:(const id *)objects
                           count:(NSUInteger)count
                            type:(IOSClass *)type {
  return [IOSObjectArray_CreateArrayWithObjects((jint)count, type, objects) autorelease];
}
...
+ (instancetype)arrayWithNSArray:(NSArray *)array type:(IOSClass *)type {
  ...
  IOSObjectArray *result = [IOSObjectArray_CreateArray((jint)count, type) autorelease];
